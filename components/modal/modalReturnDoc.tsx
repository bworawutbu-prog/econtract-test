...
import returndocIcon from "@/assets/image/modal/modalReturnDoc.webp";
import Image from "next/image";
import { X } from "lucide-react";

interface ReturnDocModalProps {
    titleName?: string;
    modalIcon?: string;
    message?: string;
    open: boolean;
...
export const ReturnDocModal: React.FC<ReturnDocModalProps> = ({
    titleName,
    modalIcon = returndocIcon,
    message = "หากคุณต้องการส่งคืนเอกสารนี้\nกรุณาระบุเหตุผลการส่งคืน",
    open,
    onConfirm,
    onCancel,
