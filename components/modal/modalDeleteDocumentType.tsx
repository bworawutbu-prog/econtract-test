...
import deletedoctypeIcon from "@/assets/image/modal/modalDeleteDocumentType.webp";
import Image from "next/image";
import { X } from "lucide-react";

interface DeleteDocTypeModalProps {
    titleName?: string;
    modalIcon?: string;
    message?: string;
    open: boolean;
...
export const DeleteDocTypeModal: React.FC<DeleteDocTypeModalProps> = ({
    titleName,
    modalIcon = deletedoctypeIcon,
    message = "คุณต้องการลบประเภทเอกสารทั้งหมดนี้ หรือไม่?",
    open,
    onConfirm,
    onCancel,
    ...
    return (
        <Modal
            ...
            onOk={onConfirm}
            onCancel={onCancel}
            style={{ maxWidth: "400px", maxHeight:"388px" }}
            closeIcon={
        ...
        >
            <div className="mt-8 mb-20 text-center">
                {modalIcon && (
                    <Image
                        src={modalIcon || deletedoctypeIcon}
