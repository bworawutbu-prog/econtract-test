...
import docemailIcon from "@/assets/image/modal/modalDocEmail.webp";
import Image from "next/image";
import { X } from "lucide-react";

interface DocEmailModalProps {
    titleName?: string;
    modalIcon?: string;
    message?: string;
    open: boolean;
...
export const DocEmailModal: React.FC<DocEmailModalProps> = ({
    titleName,
    modalIcon = docemailIcon,
    message = "คุณต้องการส่งเอกสารไปยังผู้เกี่ยวข้องนี้ หรือไม่?",
    open,
    onConfirm,
    onCancel,
    ...
    return (
        <Modal
            ...
            onOk={onConfirm}
            onCancel={onCancel}
            style={{ maxWidth: "400px", maxHeight:"445.7px" }}
            closeIcon={
