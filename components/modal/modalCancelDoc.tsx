...
import canceldocIcon from "@/assets/image/modal/modalCancelDoc.webp";
...
export const CancelDocModal: React.FC<CancelDocModalProps> = ({
    titleName,
    modalIcon = canceldocIcon,
    message = "หากคุณต้องการยกเลิกเอกสารนี้\nกรุณาระบุเหตุผลการยกเลิก",
    open,
    onConfirm,
    onCancel,
    ...
    return (
        <Modal
            ...
            onCancel={onCancel}
            style={{ maxWidth: "424px", maxHeight:"502.15px" }}
            closeIcon={
